...
It gives access to the match object, it returns the closest match if theres no arguments passed into it.

1. How would you explain form validation to someone who has never programmed before?
It lets React inform the client of any errors if the input is not correct based on what the programmer wants

1. In 1-2 sentences, define end to end testing.
It tests an application's workflow from beginning to end. It's to replicate how an actual user would operate and move around the application
